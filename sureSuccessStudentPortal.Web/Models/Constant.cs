namespace SureSuccessStudentPortal.Web.Models
{
    public static class Constant
    {
        public const string Create = "https://localhost:44309/api/Create";
        public const string GetById = "https://localhost:44346/api/Read";
